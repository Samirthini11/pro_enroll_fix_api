...
INSERT INTO service_categories (code, name_en, name_ta, icon_key, default_visit_fee_paise, sort_order)
VALUES
    ('ac', 'AC Mechanic', 'AC மெக்கானிக்', 'ac_unit', 20000, 1),
    ('plumber', 'Plumber', 'பிளம்பர்', 'plumbing', 15000, 2),
    ('electrician', 'Electrician', 'மின்சார வேலை', 'electrical_services', 15000, 3),
    ('ro', 'RO Water Service', 'RO வாட்டர் சர்வீஸ்', 'water_drop', 15000, 4),
    ('fridge', 'Fridge Repair', 'குளிர்சாதனம் ரிப்பேர்', 'kitchen', 20000, 5),
    ('wash', 'Washing Machine', 'வாஷிங் மெஷின்', 'local_laundry_service', 20000, 6),
    ('car', 'Car Mechanic', 'கார் மெக்கானிக்', 'directions_car', 25000, 7),
    ('bike', 'Bike Mechanic', 'பைக் மெக்கானிக்', 'two_wheeler', 15000, 8)
